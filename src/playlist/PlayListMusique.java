	...
	public PlayListMusique(final PlayListMusiquesControlleur controlleur)
	{
		...
		tableMorceaux.addKeyListener(new KeyListener() {
			...
			public void keyPressed(KeyEvent e) {
				...
				//Si on appuie sur entrée, on joue la musique
...
//		tableMorceaux.setBackground(new Color(253, 45, 155));	
	...
	//FIXME je n'ai pas trouvé d'autre moyen que de tout réinitialiser poiur avoir les nouvelles musiques
